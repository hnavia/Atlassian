...
# ========= CONFIGURATION =========
user = 'EMAIL'                               # Atlassian account email used for authentication
token = 'TOKEN'                              # Personal Access Token generated in Atlassian
baseurl = 'https://site.atlassian.net/'      # Base URL of your Atlassian site
output_csv = 'test.csv'                      # Name of the CSV output file
unknown = 'Unknown'                          # Placeholder for missing or deleted data (e.g., Unknown, Deleted, etc.)
# ======================================
